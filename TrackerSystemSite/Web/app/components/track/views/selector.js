...
const TrackPage = ({ devices, tracks, handleDeviceIdChange, handleTrackIdChange, handleOnSubmit, values, handleSubmit }) => (
  <div style={{ height: "100%", position: "relative" }}>
    <div style={{ position: "absolute", top: "10px", right: "10px", zIndex: "5" }}>
      ...
      <Field name="deviceId" items={devices} component={renderSelect} onSelect={handleDeviceIdChange} />    
      <Field name="trackId" items={tracks} component={renderSelect} onSelect={handleTrackIdChange} />
